...
static const unsigned long
	...
	ResizeHints = 0x8, // if enabled then dusk will respect size hints in tiled resizals
	...
	CenterSizeHintsClients = 0x200, // center tiled clients subject to size hints within their tiled area
